...
<body>
    <div id="border">
        ...
        <!-- 게시글 수정 폼 -->
        <form action="/board/memBoardUpdate.do" method="post" class="form-horizontal">
        	<sec:csrfInput/>
            ...
            <div class="form-group">
                ...
                <input type="text" id="updateDate" name="updateDate" class="form-control" value="${memBoard.updateDate}" readonly />
            </div>
            <div class="form-group">
                <button type="submit" class="btn_blue_l">수정 완료</button>
