...
public class EgovSampleController {
	...
	/*
	 * @RequestMapping(value = "/login.do") public String login() throws Exception {
	 * return "join/login"; }
	 */

	/*
	 * @PostMapping(value ="/loginSave.do") public String loginSave(Admin admin,
	 * Model model) throws Exception {
	 * 
	 * Admin adminVO = sampleService.adminLogin(admin); model.addAttribute("admin",
	 * adminVO);
	 * 
	 * System.out.println("username : " + adminVO.getUsername());
	 * System.out.println("password : " + adminVO.getPassword());
	 * System.out.println("role : " + adminVO.getRole());
	 * 
	 * return "redirect:/egovSampleList.do"; return "";
	 * 
	 * }
	 */
